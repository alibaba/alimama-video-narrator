import torch
# import clip
from transformers import ChineseCLIPProcessor, ChineseCLIPModel, AutoTokenizer,ChineseCLIPTextModel
...
class EMScorer:
    ...
    def score(self, cands, refs, vids=None, verbose=True, batch_size=64, nthreads=4, idf=True, return_matched_idx=False):
        ...
        text_model = ChineseCLIPTextModel.from_pretrained("../OFA-Sys-chinese-clip-vit-base-patch16")
        model = ChineseCLIPModel.from_pretrained("../OFA-Sys-chinese-clip-vit-base-patch16")
        preprocess = ChineseCLIPProcessor.from_pretrained("../OFA-Sys-chinese-clip-vit-base-patch16")
        tokenizer = AutoTokenizer.from_pretrained("../OFA-Sys-chinese-clip-vit-base-patch16")
        
        # model = ChineseCLIPModel.from_pretrained("/data1/yll/ControlVideoCap/metrics/EMScore/emscore_Chinese/pretrained_ckpts")
        # preprocess = ChineseCLIPProcessor.from_pretrained("/data1/yll/ControlVideoCap/metrics/EMScore/emscore_Chinese/pretrained_ckpts")
        # tokenizer = AutoTokenizer.from_pretrained("/data1/yll/ControlVideoCap/metrics/EMScore/emscore_Chinese/pretrained_ckpts")
